        ...
        for row in layout:
            ...
            for col in row:
                if col != '-1':
                    ...
                    if type == 'Gold':
                        gold = slicing_tiles(f'data/graphics/{self.level_type}Terrain/Coin/gold_coin.png', (32, 32))
                        tiles = gold[int(col)]
                        sprite = ground_tile(tile_size, [(col_index - tile_offset) * tile_size, (row_index - tile_offset) * tile_size], tiles)
                    ...
                    if type == 'Trees':
                        tree_layout = slicing_tiles(f'data/graphics/{self.level_type}Terrain/Tree/Tree_tileset.png', (32, 32))
                        tiled = tree_layout[int(col)]
                        sprite = ground_tile(tile_size, [(col_index - tile_offset) * tile_size, (row_index - tile_offset) * tile_size], tiled)
